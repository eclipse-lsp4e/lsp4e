...
import org.eclipse.lsp4e.operations.documentLink.LSPDocumentLinkPresentationReconcilingStrategy;
...
public class DocumentLinkReconcilingTest extends AbstractTestWithProject {
	...
	private LSPDocumentLinkPresentationReconcilingStrategy reconcilingStrategy = new LSPDocumentLinkPresentationReconcilingStrategy();
	...
	public void testFullDocumentLinkReconciling() throws Exception {
		...
		reconcilingStrategy.install(viewer);
	...
	public void testClippedDocumentLinkReconciling() throws Exception {
		...
		viewer.getTextWidget().setStyleRanges(new StyleRange[] {
				...
				textStyle(61, 21, COLOR_5TH_LINE) // visible part of 5th line
		});
		MockLanguageServer.INSTANCE.setDocumentLinks(CONTENT_LINKS);
